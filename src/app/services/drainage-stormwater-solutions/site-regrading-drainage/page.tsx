...
export const metadata: Metadata = {
  title: 'Site Regrading for Drainage | South Florida',
  description: 'Site regrading to fix drainage problems and eliminate standing water across South Florida. Redirect water flow away from structures.',
  openGraph: {
    title: 'Site Regrading for Drainage | South Florida',
    description: 'Site regrading to fix drainage problems and eliminate standing water across South Florida.',
    url: `${siteConfig.url}/services/drainage-stormwater-solutions/site-regrading-drainage/`,
  },
}

export default function SiteRegradingDrainagePage() {
  return (
    <main>
      <section className={styles.hero}>
        <div className={styles.container}>
          <h1 className={styles.title}>Site Regrading for Drainage</h1>
          <div className={styles.heroContent}>
            <div>
              <p className={styles.intro}>
                Site regrading to fix existing drainage problems, eliminate standing water, and 
                redirect water flow away from structures and low-lying areas across South Florida. 
                We coordinate licensed contractors to regrade sites and create proper drainage slopes.
              </p>
      ...
      <section className={styles.section}>
        <div className={styles.container}>
          <div className={styles.content}>
            ...
            <p className={styles.intro}>
              Site regrading for drainage is essential for property owners, homeowners, commercial 
              property managers, and anyone experiencing standing water, flooding, or water damage 
              due to poor site grading.
            </p>
            ...
            <div className={styles.highlightBox}>
              ...
              <p className={styles.highlightText}>
                Site regrading for drainage typically ranges from <strong>$20,000 to $75,000</strong> for 
      ...
      <section className={`${styles.section} ${styles.sectionAlt}`}>
        <div className={styles.container}>
          <div className={styles.content}>
            <h2 className={styles.heading}>What Site Regrading for Drainage Includes</h2>
      ...
      <section className={`${styles.section} ${styles.sectionAlt}`}>
        <div className={styles.container}>
          <div className={styles.content}>
            <h2 className={styles.heading}>The Site Regrading Process</h2>
            <p className={styles.text}>
        ...
        <div className={styles.container}>
          <div className={styles.content}>
            ...
            <div className={styles.faq}>
              ...
              <div className={styles.faqItem}>
                <h3 className={styles.faqQuestion}>How much does site regrading for drainage cost?</h3>
                <p className={styles.faqAnswer}>
                  Site regrading costs vary based on site size, extent of regrading required, and 
                  whether drainage systems need to be installed. Typical residential properties range 
                  from $20,000 to $75,000, while commercial properties can range from $50,000 to 
                  $200,000+ depending on scope. Factors affecting cost include site access, required 
                  earthwork, and drainage system complexity.
                </p>
              </div>
              <div className={styles.faqItem}>
      ...
      <section className={`${styles.section} ${styles.sectionAlt}`}>
        <div className={styles.container}>
          <div className={styles.content}>
            ...
            <p className={styles.text}>
              We coordinate site regrading for drainage across all of South Florida. Select your 
              location to learn more about drainage solutions in your area:
            </p>
            <div className={styles.locationsGrid}>
              <a href="/services/drainage-stormwater-solutions/site-regrading-drainage/miami/" className={styles.locationCard}>
              ...
              <a href="/service-areas/fort-lauderdale/drainage-stormwater-solutions/site-regrading-drainage/" className={styles.locationCard}>
              ...
              <a href="/services/drainage-stormwater-solutions/site-regrading-drainage/west-palm-beach/" className={styles.locationCard}>
              ...
              <a href="/services/drainage-stormwater-solutions/site-regrading-drainage/florida-keys/" className={styles.locationCard}>
