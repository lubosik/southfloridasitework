        ...
        <div className={styles.container}>
          <div className={styles.content}>
            ...
            <div className={styles.locationsGrid}>
              ...
              <a href="/service-areas/fort-lauderdale/site-work-site-development/value-engineering-preconstruction/" className={styles.locationCard}>
              ...
              <a href="/service-areas/west-palm-beach/site-work-site-development/value-engineering-preconstruction/" className={styles.locationCard}>
