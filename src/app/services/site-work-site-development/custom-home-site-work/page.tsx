        ...
        <div className={styles.container}>
          <div className={styles.content}>
            ...
            <div className={styles.locationsGrid}>
              <a href="/service-areas/miami/site-work-site-development/custom-home-site-work/" className={styles.locationCard}>
              ...
              <a href="/service-areas/fort-lauderdale/site-work-site-development/custom-home-site-work/" className={styles.locationCard}>
              ...
              <a href="/service-areas/west-palm-beach/site-work-site-development/custom-home-site-work/" className={styles.locationCard}>
